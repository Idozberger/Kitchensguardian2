            ...
            child: Column(
              ...
              children: [
                if (mergedMealPlanEntity.breakfast != null) ...[
                  ...
                  UpperTile(
                    widget: RecipeTileItem(
                      recipe: mergedMealPlanEntity.breakfast as MealTypeModel,
                ...
                if (mergedMealPlanEntity.lunch != null) ...[
                  ...
                  UpperTile(
                    widget: RecipeTileItem(
                      recipe: mergedMealPlanEntity.lunch as MealTypeModel,
                      selectedDate: mergedMealPlanEntity.date,
                ...
                if (mergedMealPlanEntity.dinner != null) ...[
                  ...
                  UpperTile(
                    widget: RecipeTileItem(
                      recipe: mergedMealPlanEntity.dinner as MealTypeModel,
                      selectedDate: mergedMealPlanEntity.date,
